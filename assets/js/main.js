...
function linkAction() {
  const navMenu = document.getElementById("nav-menu")
  // When we click on a nav__link, we remove the show-menu class
  navMenu.classList.remove("show-menu")
}
...
const skillsContent = document.getElementsByClassName("skills__content"),
  ...
  skillSet = document.querySelectorAll(".skills__set")
...
const modalViews = document.querySelectorAll(".services__modal"),
  modalOpenBtns = document.querySelectorAll(".services__button"),
  modalCloseBtns = document.querySelectorAll(".services__modal-close")

let setActiveModal = function (modal) {
...
// Activte / Deactivate the theme manually with the button
themeButton.addEventListener("click", () => {
  // Add or remove the dark / icon theme
  document.body.classList.toggle(darkTheme)
  themeButton.classList.toggle(iconTheme)
  // We save the theme and icon
